...
class db_Mysql
{
     ...
     * 起用强制更新cache
     */
    public function update_cache($key = FALSE)
    {
     ...
     * @return string
     */
    public function cache_made_key($a, $b)
    {
     ...
     * @param array $values
     */
    public function joinQuery($sql, $values = array())
    {}
     ...
     */
    public function getTablesLists()
    {
     ...
     */
    public function query($sql, $values = array(), $type = '')
    {
    ...
    public function getCol($sql, $values = array(), $column_number = 0)
    {
        $columns = array();
        $results = array();
     ...
     */
    public function getOne($sql, $values = array(), $column_number = 0)
    {
        $this->query($sql, $values);
     ...
     * @return boolean
     */
    public function insert($table = NULL, $data = NULL, $returnStr = FALSE)
    {
