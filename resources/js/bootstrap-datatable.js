...
(function ($) {
    ...
    DataTable.prototype = {
        ...
        constructor: DataTable, render: function () {
            ...
            if (o.url !== "") {
                $.ajax({
                    url: o.url, type: "GET", dataType: "json", data: $.extend({}, o.post, {
                        currentPage: o.currentPage, perPage: o.perPage, sort: o.sort, filter: o.filter
...
//            if (o.columns[column].html && o.columns[column].html)
            ...
            $cell
                ...
                .attr('data-original-title', o.columns[column].comment);
    ...
    function _initTableInfo() {
        ...
        $($info).popover({
            placement: "bottom", content: $('<dl></dl>').append(
    ...
    function _saveColumns() {
        ...
        $.ajax({
            url: o.url, type: "POST", dataType: "json", data: $.extend({}, o.post, {
                action: "save-columns", columns: JSON.stringify(o.columns), sort: JSON.stringify(o.sort), filter: JSON.stringify(o.filter)
            }), success: function (res) {
    ...
    $.fn.datatable.defaults = {
        debug: false, id: undefined, title: 'Data Table Results', class: 'table table-striped table-bordered', perPage: 10, pagePadding: 2, sort: [
            []
